...
export default function Page({objects, socket}){
    ...
    useEffect(()=>{
        ...
        //     // if(reqData.title === 'addPart'){
        //     //     dispatch(addPartAllClients(reqData.data))
        //     // }
        //     // else if(reqData.title === 'deletePart'){
        //     //     dispatch(deletePartAllClients(reqData.data))
        //     // }
        //     // else if(reqData.title === 'updateCountPart'){
        //     //     dispatch(updateCountPartAllClient(reqData.data))
        //     // }
        //     // else if(reqData.title === 'sendPart'){
        //     //     dispatch(sendPartAllClients(reqData.data))
        //     // }
        // })
    ...
    async function sendData(e){
        ...
        .then(res=>{
            ...
            socket.send(JSON.stringify(res.data.newTech))
            router.push('/objects')
        })
        .catch(e=>console.log(e))
        //revalidateTag('objects')
